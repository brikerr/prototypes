...
html: '<i class="material-icons" style="font-size: 100px; color: #7ED321">add</i>'

redicon = new Layer scale: 0, backgroundColor: "", 
html: '<i class="material-icons" style="font-size: 100px; color: #F14051">close</i>'
...
for layer, i in smallCards
	...
	layer.on Events.Click, ->
		...
		if not horizontalScroll.isMoving
