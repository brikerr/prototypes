...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Layer = (function(superClass) {
	  ...
	  Layer.prototype.onEdgeSwipe = function(cb) {
	    return this.on(Events.EdgeSwipe, cb);
	  };
	
	  Layer.prototype.onEdgeSwipeStart = function(cb) {
	    return this.on(Events.EdgeSwipeStart, cb);
	  };
	
	  Layer.prototype.onEdgeSwipeEnd = function(cb) {
	    return this.on(Events.EdgeSwipeEnd, cb);
	  };
	
	  Layer.prototype.onEdgeSwipeTop = function(cb) {
	    return this.on(Events.EdgeSwipeTop, cb);
	  };
	
	  Layer.prototype.onEdgeSwipeTopStart = function(cb) {
	    return this.on(Events.EdgeSwipeTopStart, cb);
	  };
	
	  Layer.prototype.onEdgeSwipeTopEnd = function(cb) {
	    return this.on(Events.EdgeSwipeTopEnd, cb);
	  };
	
	  Layer.prototype.onEdgeSwipeRight = function(cb) {
	    return this.on(Events.EdgeSwipeRight, cb);
	  };
	
	  Layer.prototype.onEdgeSwipeRightStart = function(cb) {
	    return this.on(Events.EdgeSwipeRightStart, cb);
	  };
	
	  Layer.prototype.onEdgeSwipeRightEnd = function(cb) {
	    return this.on(Events.EdgeSwipeRightEnd, cb);
	  };
	
	  Layer.prototype.onEdgeSwipeBottom = function(cb) {
	    return this.on(Events.EdgeSwipeBottom, cb);
	  };
	
	  Layer.prototype.onEdgeSwipeBottomStart = function(cb) {
	    return this.on(Events.EdgeSwipeBottomStart, cb);
	  };
	
	  Layer.prototype.onEdgeSwipeBottomEnd = function(cb) {
	    return this.on(Events.EdgeSwipeBottomEnd, cb);
	  };
	
	  Layer.prototype.onEdgeSwipeLeft = function(cb) {
	    return this.on(Events.EdgeSwipeLeft, cb);
	  };
	
	  Layer.prototype.onEdgeSwipeLeftStart = function(cb) {
	    return this.on(Events.EdgeSwipeLeftStart, cb);
	  };
	
	  Layer.prototype.onEdgeSwipeLeftEnd = function(cb) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.LayerDraggable = (function(superClass) {
	  ...
	  LayerDraggable.prototype.attach = function() {
	    ...
	    return this.layer.on(Gestures.TapEnd, this._touchEnd);
	  };
	  ...
	  LayerDraggable.prototype._touchMove = function(event) {
	    ...
	    if (this.horizontal) {
	      point.x += event.delta.x * (1 / this.layer.canvasScaleX() * this.layer.scale * this.layer.scaleX);
	    }
	    if (this.vertical) {
	      point.y += event.delta.y * (1 / this.layer.canvasScaleY() * this.layer.scale * this.layer.scaleY);
	    }
	    if (this._constraints) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DOMEventManager, GestureInputDoubleTapTime, GestureInputEdgeSwipeDistance, GestureInputForceTapDesktop, GestureInputForceTapMobile, GestureInputForceTapMobilePollTime, GestureInputLongPressTime, GestureInputSwipeThreshold, GestureInputVelocityTime, Utils,
	  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
	...
	exports.GestureInputRecognizer = (function() {
	  ...
	  GestureInputRecognizer.prototype.touchend = function(event) {
	    ...
	    if (!((event.touches.length === 0) || (event.touches.length === event.changedTouches.length))) {
	      return;
	    }
	  ...
	  GestureInputRecognizer.prototype._getGestureEvent = function(event) {
	    var events, i, len, pointA, pointB, pointKey, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, ref8;
	    _.extend(event, {
	      time: Date.now(),
	      point: {
	        x: event.pageX,
	    ...
	    if ((ref3 = this.session) != null ? ref3.events : void 0) {
	      events = _.filter(this.session.events, function(e) {
	        return e.time > (event.time - GestureInputVelocityTime);
	      });
	      event.velocity = this._getVelocity(events);
	    }
	    if (event.fingers > 0) {
	      event.angle = 0;
	      if ((ref4 = this.session) != null ? ref4.startEvent : void 0) {
	        pointA = this._getTouchPoint(this.session.startEvent, 0);
	        pointB = this._getTouchPoint(event, 0);
	    ...
	    if (event.fingers > 1) {
	      pointA = this._getTouchPoint(event, 0);
	      pointB = this._getTouchPoint(event, 1);
	    ...
	    if ((ref5 = this.session) != null ? ref5.lastEvent : void 0) {
	      if (this.session.lastEvent.fingers !== event.fingers) {
	        event.delta = {
	          x: 0,
	          y: 0
	        };
	        ...
	        event.deltaAngle = Utils.pointAngle(this.session.lastEvent.touchCenter, event.touchCenter);
	      }
	      event.deltaDirection = this._getDirection(event.delta);
	    }
	    if ((ref6 = this.session) != null ? ref6.started.pinch : void 0) {
	      event.scale = event.touchDistance / this.session.started.pinch.touchDistance;
	    }
	    if ((ref7 = this.session) != null ? ref7.force : void 0) {
	      event.force = this.session.force;
	    }
	    ref8 = ["point", "start", "previous", "offset", "delta", "velocity", "touchCenter", "touchOffset"];
...
/***/ function(module, exports) {
	...
	exports.date = 1453828393;
	
	exports.branch = "master";
	
	exports.hash = "3d977bc";
